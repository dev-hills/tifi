...
const ContactPortfolio: React.FC<PortfolioProps> = ({ title, description }) => {
  ...
  return (
    <main>
      <h2 class="lg:text-[72px] md:text-[48px]  text-[32px] mb-6 text-center w-full px-4 lg:w-[60%] md:w-[70%] mx-auto font-semibold font-red-hat">Let us know how we can help you.</h2>
      <div className="text-[16px] w-[100%] lg:w-[50%] md:w-[70%] font-noto-sans text-center mx-auto">
